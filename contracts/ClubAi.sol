...
contract CLUBAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0x89469f1d881847379b11E0ea8C470D355fB7FF89); // Marketing Address
    ...
    uint256 private _tTotal = 1000000000 * 10**9; //1,000,000,000  10,000,000,000,000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'CLUB AI';
    string private _symbol = 'CLUBAI ';
    ...
    function initContract() external onlyOwner {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            deadAddress // change berfore deploy to pancake
        );
